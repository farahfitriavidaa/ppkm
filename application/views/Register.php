                                ...
                                <form action="<?=base_url()?>Register/registKonsumen" method="POST">
                                    ...
                                    <div class="single-input-item">
                                        <div class="login-reg-form-meta">
                                            ...
                                            Sudah punya akun? <a href="<?=base_url()?>Login" class="forget-pwd">Klik disini</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="single-input-item">
